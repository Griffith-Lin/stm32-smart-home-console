...
* 函 数 名 : I2S2_Init
* 功能说明 : I2S2初始化
* 形    参 : I2S_Standard:  		@ref SPI_I2S_Standard  I2S标准
									I2S_Standard_Phillips，飞利浦标准；
									I2S_Standard_MSB，MSB对齐标准(右对齐)；
									I2S_Standard_LSB，LSB对齐标准(左对齐);
									I2S_Standard_PCMShort，I2S_Standard_PCMLon：PCM标准
			 ...
			 I2S_Clock_Polarity:  	@ref SPI_I2S_Clock_Polarity
									I2S_CPOL_Low，时钟低电平有效；
									I2S_CPOL_High，时钟高电平有效；
			 I2S_DataFormat：		@ref SPI_I2S_Data_Format
									I2S_DataFormat_16b,16位标准；
...
/*********************************************************************************************************
 * 函 数 名 : I2S2_SampleRate_Set
 * 功能说明 : 设置IIS的采样率(@MCKEN)
 * 形    参 : samplerate：采样率，单位:Hz
 * 返 回 值 : 0：设置成功；1：无法设置
 * 备    注 : 无
 *********************************************************************************************************/
...
/*********************************************************************************************************
 * 函 数 名 : I2S2_TX_DMA_Init
 * 功能说明 : I2S2 TX DMA配置
 * 形    参 : buf0：M0AR地址；buf1：M1AR地址；num：每次传输数据量；
 * 返 回 值 : 无
 * 备    注 : 设置为双缓冲模式,并开启DMA传输完成中断
 *********************************************************************************************************/
